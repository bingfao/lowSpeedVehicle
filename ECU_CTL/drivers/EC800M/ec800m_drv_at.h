...
#define DRV_EC800M_CMD_GET_UTC_TIME      NET_PORT_CMD_GET_UTC_TIME
#define DRV_EC800M_CMD_GET_GNSS          NET_PORT_CMD_GET_GNSS
#define DRV_EC800M_CMD_SET_QAUGDCNT      NET_PORT_CMD_SET_TRAFFIC_STATISTICS_RECODER_PERIOD
#define DRV_EC800M_CMD_GET_QGDCNT        NET_PORT_CMD_GET_TRAFFIC_STATISTICS
#define DRV_EC800M_CMD_CLR_FLOW          NET_PORT_CMD_CLR_TRAFFIC_STATISTICS
